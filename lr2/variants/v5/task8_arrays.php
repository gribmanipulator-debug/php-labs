 ...
 *
 * Варіант 5: createArray() (3-7, 10-20), merge + unique + sort ascending
 */
...
<div class="demo-card demo-card-wide">
    ...
    <p class="demo-subtitle">createArray(), з'єднання, видалення дублікатів, сортування</p>
