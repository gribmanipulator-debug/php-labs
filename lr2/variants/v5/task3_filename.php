 ...
 *
 * Варіант 5: "D:\Music\Collection\melody.mp3"
 */
...
$path = $_POST['path'] ?? 'D:\Music\Collection\melody.mp3';
...
<div class="demo-card">
    ...
    <form method="post" class="demo-form">
        <div>
            ...
            <input type="text" id="path" name="path" value="<?= htmlspecialchars($path) ?>" placeholder="D:\Music\file.mp3">
        </div>
