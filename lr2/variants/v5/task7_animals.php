 ...
 *
 * Варіант 5: склади "зі мо ну ра ти хо ві ді бу", 3 імені, 4 складів на ім'я
 */
 ...
 */
function generateAnimalName(array $syllables, int $count = 4): string
{
    if (empty($syllables)) {
        return '';
    }
 ...
 * Генерує кілька імен
 */
function generateMultipleNames(array $syllables, int $namesCount = 3, int $syllablesPerName = 4): array
{
    $names = [];
...
$syllablesInput = $_POST['syllables'] ?? 'зі мо ну ра ти хо ві ді бу';
...
<div class="demo-card">
    ...
    <form method="post" class="demo-form">
        <div>
            ...
            <input type="text" id="syllables" name="syllables" value="<?= htmlspecialchars($syllablesInput) ?>" placeholder="зі мо ну ра ти">
        </div>
        <div class="form-row">
            <div>
