<?php
/**
 * Shared layout template for LR2 Variant 5 task pages
 */
...
function renderVariantLayout(string $content, string $taskName, string $bodyClass = ''): void
{
    ...
    $demoUrl = "/lr2/demo/{$currentTask}?from=v5";
    ?>
<!DOCTYPE html>
<html lang="uk">
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($taskName) ?> — Варіант 5 ЛР2</title>
...
<body class="body-with-header <?= htmlspecialchars($bodyClass) ?>">
    <header class="header-fixed">
        ...
        <div class="header-right">
            <span class="header-variant-label">В-5</span>
